...
export const originalChannels: Channel[] = [
  ...
  { id: "pluto-sports", number: 148, name: "Pluto TV Sports", url: "https://service-stitcher.clusters.pluto.tv/v1/stitch/embed/hls/channel/5ca7f16c37b88b26947346b1/master.m3u8?advertisingId=channel&appName=rokuchannel&appVersion=1.0&bmodel=bm1&channel_id=channel&content=channel&content_rating=UNRATED&content_type=livefeed&coppa=false&deviceDNT=1&deviceId=channel&deviceMake=rokuChannel&deviceModel=web&deviceType=rokuChannel&deviceVersion=1.0&embedPartner=rokuChannel&genre=SPORTS&is_lat=1&platform=web&rdid=channel&studio_id=viacom&tags=LIVESPORTS", category: "Sports" },
